...
namespace HangFireAPIschuduler.Controllers
{
    // manuel Hangfire adında  bir boş database olustur.. tablolarını kendi otomatik olusturur.
    // https://www.c-sharpcorner.com/article/hangfire-in-net-core-6-background-jobs/#:~:text=Hangfire%20is%20an%20open%2Dsource,and%20gives%20a%20powerful%20performance.
    [ApiController]
        public class HomeController : Controller
        {
            [HttpGet]
            [Route("DovizFireAndForgetJob")]
            public string DovizFireAndForgetJob()
            {
                //Fire - and - Forget Jobs
                //Fire - and - forget jobs are executed only once and almost immediately after creation.
                //var jobId = BackgroundJob.Enqueue(() => Console.WriteLine("Welcome user in Fire and Forget Job Demo!"));           
                var jobId = BackgroundJob.Enqueue(() => DovizKuru());

                return $"Job ID: {jobId}. DovizFireAndForgetJob and Forget Job Demo!";
            }

            public static void DovizKuru()
            {
                Console.WriteLine("DovizKuru Welcome user in Fire and Forget Job Demo!");
            }
        ...
        [HttpGet]
            ...
            RecurringJob.AddOrUpdate(() => DovizKuru(), Cron.Minutely);

            return "DovizKuru Welcome user in Recurring Job Demo!";
            }
